...
from sportagenda.apps.events.models import Event, Season
from sportagenda.apps.stats.api.serializers import (
    ProfileStatSerializer, StatisticPolymorphicSerializer)
from sportagenda.apps.stats.models import Statistic
from sportagenda.apps.users.api.serializers import BaseProfileSerializer
