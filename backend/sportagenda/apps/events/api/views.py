...
from sportagenda.apps.events.api.serializers import (
    AccommodationSerializer, CategorySerializer, EventPolymorphicSerializer,
    EventResponseSerializer, EventTypeSerializer, LocationSerializer,
    RaceOrganizerSerializer, SeasonSerializer, SkisTypeSerializer)
from sportagenda.apps.events.models import (Accommodation, Category, Event,
                                            EventResponse, EventType, Location,
                                            RaceOrganizer, Season, SkisType)
...
from sportagenda.apps.family.models import Child, FamilyMember
