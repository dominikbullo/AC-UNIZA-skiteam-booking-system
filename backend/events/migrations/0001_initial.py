    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(default='Default Title For Event', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('skis_type', models.CharField(choices=[('GS', 'Giant Slalom'), ('SL', 'Slalom'), ('ALL', 'All')], default='ALL', max_length=3)),
        ...
        migrations.AddField(
            model_name='event',
            name='location',
            field=models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, to='events.Location'),
        ),
    ]
