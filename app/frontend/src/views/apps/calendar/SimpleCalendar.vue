<template>
    <div id="simple-calendar-app">
                ...
                <div slot="header" class="mb-4">
                    ...
                    <div class="vx-row no-gutter">
                        ...
                        <div class="vx-col w-1/3 items-center sm:flex hidden">
                            ...
                            <!--                            <vs-button icon-pack="feather" icon="icon-plus" @click="promptAddNewEvent(new Date())">Add-->
                            <!--                            </vs-button>-->
                        </div>
        ...
        <!--                <vs-chip v-if="labelLocal != 'none'" class="text-white" :class="'bg-' + labelColor(labelLocal)">{{-->
        <!--                    labelLocal }}-->
        <!--                </vs-chip>-->

        <!--                <vs-dropdown vs-custom-content vs-trigger-click class="ml-auto my-2 cursor-pointer">-->

        <!--                    <feather-icon icon="TagIcon" svgClasses="h-5 w-5" class="cursor-pointer"-->
        <!--                                  @click.prevent></feather-icon>-->

        <!--                    <vs-dropdown-menu style="z-index: 200001">-->
        <!--                        <vs-dropdown-item v-for="(label, index) in calendarLabels" :key="index"-->
        ...
        <!--            </div>-->
        <!--            <vs-input name="event-url" v-validate="'url'" class="w-full mt-6" label-placeholder="Event URL"-->
        <!--                      v-model="url" :color="!errors.has('event-url') ? 'success' : 'danger'"></vs-input>-->
