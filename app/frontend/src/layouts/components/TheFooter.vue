...
<template functional>
    <footer class="the-footer flex-wrap justify-between" :class="classes">
        <p>
            ...
            <span v-if="new Date().getFullYear() === 2020">{{ new Date().getFullYear() }} </span>
            <span v-else>2020 - {{ new Date().getFullYear() }} </span>
            <a href="http://wecanmakeit.online/" target="_blank" rel="nofollow">WeCanMakeIt.online</a>
