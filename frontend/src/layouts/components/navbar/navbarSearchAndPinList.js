...
export default {
  pages: {
    ...
    data: [
      ...
      {title: "Calendar",                   url: "/apps/event/calendar",                icon: "CalendarIcon",       is_bookmarked: true},
      {title: "Change Family",              url: "/pages/user-settings#family",         icon: "UsersIcon",          is_bookmarked: true},
      {title: "Add Child",                  url: "/apps/family/members#addchild",       icon: "UserPlusIcon",       is_bookmarked: true},
