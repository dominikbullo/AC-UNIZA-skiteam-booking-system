    ...
    <div class="vx-row">
      ...
      <div class="vx-col w-full lg:w-1/3 mb-base">
        <vx-card title="Customers">
          ...
          <div slot="no-body">
            <!-- CHART -->
            <vue-apex-charts type="pie" height="334" class="my-12" :options="analyticsData.customersPie.chartOptions"
        ...
        <vx-card title="Sales" subtitle="Last 6 Months">
          ...
          <div class="flex">
            <span class="flex items-center"><div
              class="h-3 w-3 rounded-full mr-2 bg-primary"></div><span>Sales</span></span>
            <span class="flex items-center ml-5"><div
              class="h-3 w-3 rounded-full mr-2 bg-success"></div><span>Visits</span></span>
          </div>
          <!-- CHART -->
          <div slot="no-body-bottom">
            <vue-apex-charts type="radar" :options="analyticsData.statisticsRadar.chartOptions"
        ...
        <vx-card class="overflow-hidden">
          <template slot="no-body">
            <div
              ...
              <div>
                <p><span class="font-semibold">{{ todoToday.numComletedTasks }} task completed</span> out of {{
                  todoToday.totalTasks }}</p>
              ...
              <li class="px-6 py-4 tasks-today__task" v-for="todo in todoToday.tasksToday" :key="todo.id">
                <div class="vx-row">
                  ...
                  <div class="tasks-today__actions vx-col w-full sm:w-auto ml-auto mt-2 sm:mt-0">
                    <vs-button radius color="primary" type="border" icon-pack="feather" icon="icon-check"
                               size="small"></vs-button>
                    <vs-button radius color="primary" type="border" icon-pack="feather" icon="icon-edit-2" size="small"
                               class="ml-3"></vs-button>
    ...
    <div class="vx-row">
      <div class="vx-col w-full md:w-2/3 lg:w-3/4">
        <vx-card title="Sales" class="mb-base">
          ...
          <div slot="no-body" class="p-6 pb-0">
            <vue-apex-charts type="line" height="266" :options="analyticsData.salesLine.chartOptions"
        ...
        <vx-card>
          <template slot="no-body" v-if="Object.entries(funding).length">
            <div class="p-8 clearfix">
              ...
              <vs-button icon-pack="feather" icon="icon-chevrons-right" icon-after class="shadow-md w-full">Add Funds
              </vs-button>
            </div>
