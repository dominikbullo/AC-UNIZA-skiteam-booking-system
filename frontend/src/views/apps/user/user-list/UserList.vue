<template>
  ...
  <div id="page-user-list">
    ...
    <!--                    class="mb-4 md:mb-0"/>-->
    <!--        </div>-->
    <!--        &lt;!&ndash;        <div class="vx-col md:w-1/4 sm:w-1/2 w-full">&ndash;&gt;-->
    <!--        &lt;!&ndash;          <label class="text-sm opacity-75">Status</label>&ndash;&gt;-->
    <!--        &lt;!&ndash;          <v-select :options="statusOptions" :clearable="false" :dir="$vs.rtl ? 'rtl' : 'ltr'" v-model="statusFilter" class="mb-4 md:mb-0" />&ndash;&gt;-->
    <!--        &lt;!&ndash;        </div>&ndash;&gt;-->
    <!--        <div class="vx-col md:w-1/4 sm:w-1/2 w-full">-->
    ...
    <!--        </div>-->
    <!--        &lt;!&ndash;        <div class="vx-col md:w-1/4 sm:w-1/2 w-full">&ndash;&gt;-->
    <!--        &lt;!&ndash;          <label class="text-sm opacity-75">Department</label>&ndash;&gt;-->
    <!--        &lt;!&ndash;          <v-select :options="departmentOptions" :clearable="false" :dir="$vs.rtl ? 'rtl' : 'ltr'" v-model="departmentFilter" />&ndash;&gt;-->
    <!--        &lt;!&ndash;        </div>&ndash;&gt;-->
    <!--      </div>-->
    <!--    </vx-card>-->
